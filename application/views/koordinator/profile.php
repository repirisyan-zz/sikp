    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <?php echo form_open('Koordinator/Profile/ubah_password','class="form_login"');?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <?php echo form_open_multipart('Koordinator/Profile/upload_foto','class="form_login"');?>
                    <div class="form-group row">
...
<div class="modal fade" id="uploadSampul" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <?php echo form_open_multipart('Koordinator/Profile/upload_sampul','class="form_login"');?>
                    <div class="form-group row">
