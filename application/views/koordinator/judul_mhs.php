    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                <h5 class="modal-title text-primary text-center" id="staticBackdropLabel">Judul Kerja Praktek</h5>
                <br>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="judul" value="<?php echo $judul?>" maxlength="255"
                            required>
                    </div>
                </div>
