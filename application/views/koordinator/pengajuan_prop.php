                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="container">
                                                        ...
                                                        <input type="number" name="rekomendasi"
                                                            value="<?php echo $rekomendasi?>" hidden>
                                                        <input type="text" name="npm" value="<?php echo $npm?>" hidden>
                                                        <div class="form-group row">
                                                            <label for="inputPassword"
                                                                class="col-sm-4 col-form-label">Berkas Revisi</label>
                                                            <div class="col-sm-8">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <textarea name="keterangan" class="form-control"
                                                                    cols="36" maxlength="100" rows="5"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
